...
console.log('Test access sessionProps property', testModel.admin);
...
const clonedUser = testModel.clone() as UserModel;
...
testModel.complexObj.a = '1';
testModel.complexObj.b = '2';
console.log(
  'A should be A:',
  clonedUser.complexObj.a,
  ' / A should be 1',
  testModel.complexObj.a,
);
console.log('-------- TEST TO STRING -----------');

console.log('To string:', testModel.toString());
console.log('To string sessionProps:', testModel.toStringSession());
